...
$(document).on("click", ".animals", function () {
  ...
  $.ajax({
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      console.log("yes");
      animalImage.addClass("animal-images");
      // 
...
$(".animal-images").on("click", function () {
  console.log("Hey there!")

  // var animalImage;
  $(".animal-images").attr("src", $(this).attr("still"));
  $(".animal-images").attr(("data-state", $(this).attr("data-state", "animate")));
...
//   animalImage.attr(("data-state", (this).attr("data-state", "animate")));
